  ...
  return (
    ...
    >
      ...
      >
        ...
        >{estado ? "Login" : "Sign up"}</button>

        <button onClick={()=>setEstado(!estado)} className="text-[#4CAD73] mb-[60px]" href="">
          <p>{estado ? "Not have an account? Sign up" : "You already have an account,Login"}</p>
        </button>
      </div>
    </div>
  );
